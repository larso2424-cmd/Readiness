    ...
    <div className="min-h-screen px-5 py-12" style={{ background: 'var(--bg)', color: 'var(--text-primary)' }}>
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <p>These Terms of Use constitute a legally binding agreement between you and <strong style={{ color: 'var(--text-primary)' }}>StudyReady</strong>, operated by <strong style={{ color: 'var(--text-primary)' }}>Lars Peters</strong> ("we," "us," or "our"), governing your access to and use of our services at <a href="https://studyready.org" className="underline" style={{ color: 'var(--accent)' }}>https://studyready.org</a>. By accessing the Services, you agree to be bound by these Terms. If you do not agree, please discontinue use immediately. You can contact us at <a href="mailto:peters.o.lars@icloud.com" className="underline" style={{ color: 'var(--accent)' }}>peters.o.lars@icloud.com</a>.</p>
